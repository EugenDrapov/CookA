...
// PASTLWTR : 1.2
// File generated on 13.11.2009 17:46:27 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Projects\DrvFR_4.9\Source\DrvFR\DrvFR.tlb (1)
...
// *********************************************************************//
  ...
  private
    FIntf: IDrvFR48;
    function  GetControlInterface: IDrvFR48;
  protected
  ...
  public
    ...
    property  ControlInterface: IDrvFR48 read GetControlInterface;
    property  DefaultInterface: IDrvFR48 read GetControlInterface;
...
// *********************************************************************//
// The Class CoDrvFR1C provides a Create and CreateRemote method to          
// create instances of the default interface IDrvFR1C exposed by              
// the CoClass DrvFR1C. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoDrvFR1C = class
    class function Create: IDrvFR1C;
    class function CreateRemote(const MachineName: string): IDrvFR1C;
  end;
...
procedure TDrvFR.CreateControl;
  ...
  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IDrvFR48;
  end;
...
function TDrvFR.GetControlInterface: IDrvFR48;
begin
  CreateControl;
  Result := FIntf;
end;
...
class function CoDrvFR1C.Create: IDrvFR1C;
begin
  Result := CreateComObject(CLASS_DrvFR1C) as IDrvFR1C;
end;

class function CoDrvFR1C.CreateRemote(const MachineName: string): IDrvFR1C;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DrvFR1C) as IDrvFR1C;
end;
